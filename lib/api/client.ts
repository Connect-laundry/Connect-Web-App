...
// Use local API routes by default, fall back to external backend if configured
...
export async function apiClient<T = any>(
  ...
  console.log('[connectlaundry.app] API Request:', {
    url,
  ...
  try {
    ...
    console.log('[connectlaundry.app] API Response Status:', response.status)
  } catch (error: any) {
