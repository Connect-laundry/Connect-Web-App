...
import { getDashboardStats, getDashboardEarnings, getRecentOrders } from '@/lib/api/dashboard'
import { DashboardStats, DashboardEarnings, OrderListResponse } from '@/lib/types'
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-10">
        ...
        <div className="flex items-center gap-3">
          ...
          <Avatar className="h-10 w-10 border border-border/50 cursor-pointer hover:opacity-80 transition-opacity">
            <AvatarImage src="/api/images/placeholder-user.jpg" />
